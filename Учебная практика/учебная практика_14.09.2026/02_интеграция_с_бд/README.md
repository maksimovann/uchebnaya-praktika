...
Результат запроса дополняется процентом из `calculate_partner_discount`. Проверки находятся в `tests/test_database.py`. Полный запуск с PostgreSQL описан в четвертом задании.
